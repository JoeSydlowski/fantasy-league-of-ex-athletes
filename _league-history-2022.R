...
sleeper_draft_history <- 
  get_draft_history_sleeper(2021) %>% 
  mutate(across(.cols = c(season, player_id),
                .fns = as.integer))
...
sleeper_standings_history <- 
  get_standings_history_sleeper(2021) %>% 
  mutate(season = 2021,
         league_rank = case_when(
           user_name == "rgalletti" ~ 1,
           user_name == "scottydontknovv" ~ 2,
           user_name == "LizandroS23" ~ 3,
           user_name == "EricBu" ~ 4,
           user_name == "jsydlow99ski" ~ 5,
           user_name == "terryclark1991" ~ 6,
           user_name == "Galletti" ~ 7,
           user_name == "nickd1212" ~ 8,
           user_name == "sox05syd" ~ 9,
           user_name == "JTNoel" ~ 10,
           user_name == "AnthonyClay" ~ 11,
           user_name == "TyNoel" ~ 12
         ))
...
saveRDS(flea_df, "data/flea_df.RDS")
